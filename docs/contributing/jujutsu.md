...
patch stack. If you prefer Git, see [Working with stack of
patches Quick Reference](stack_quickref.md).
:::
...
A [co-located repository](https://jj-vcs.github.io/jj/latest/git-compatibility/#co-located-jujutsugit-repos)
...
renames](https://github.com/jj-vcs/jj/issues/6940) and `git am` for
[importing patches](https://github.com/jj-vcs/jj/issues/2702). See also
