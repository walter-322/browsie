...
but [Breakpad](http://kb.mozillazine.org/Breakpad) fails because it's
...
Debugging Tools for
Windows](https://docs.microsoft.com/en-us/windows-hardware/drivers/download-the-wdk).
...
builds under
[http://ftp.mozilla.org/pub/mozilla.o.../latest-trunk/](https://ftp.mozilla.org/pub/firefox/nightly/latest-mozilla-central/).
...
**c:tempfirefox-debug-(Today's Date).txt** on your hard drive. To
provide the information to the development community, submit this file
with a [support request](https://support.mozilla.com/) or attach it
to a related bug on [Bugzilla](https://bugzilla.mozilla.org/).
